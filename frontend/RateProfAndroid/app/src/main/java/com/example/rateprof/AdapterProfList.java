...
public class AdapterProfList extends RecyclerView.Adapter<AdapterProfList.ViewHolder> {
    private List<String> names;
    private Context context;

    public AdapterProfList(List<String> names, Context context) {
        this.names = names;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.buttonItem.setOnClickListener(v -> {
            Intent intent = new Intent(context, ProfListActivity.class);
